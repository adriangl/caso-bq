...
public class DoubleClickListView extends ListView {
	...
	public DoubleClickListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	
	public DoubleClickListView(Context context, AttributeSet attrs, int defStyle) {
